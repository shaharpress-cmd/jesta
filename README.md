...
אפליקציית עזרה הדדית לפי מיקום (PWA, עברית RTL) — מי שצריך ג׳סטה ומי שרוצה לתת. מפרסמים טובות לא-מקצועיות — דלק, הרמת מקרר, מדף, קניות, גינה וכו׳. הפלטפורמה מתווכת בלבד.
