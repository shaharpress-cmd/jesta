...
export const SAFETY = {
  ...
  /** חובה בכל דפי טיפים, יחד עם intermediary */
  tipsDisclaimer:
  ...
  /** חירום — לצירוף לבלוק טיפים מורחב */
  tipsEmergency:
    "במצב חירום התקשרו 100 (משטרה), 101 (מד״א) או 102 (כיבוי אש). ג׳סטה אינה תחליף לשירות מקצועי או לחירום.",
};
